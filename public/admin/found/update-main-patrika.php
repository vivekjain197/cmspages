...
if(isset($_POST['submit']))
{
              ...
              if($imgSize < 1000000)
              {
                 ...
                 if(move_uploaded_file($tmp_dir,$upload_dir.$userpic))
                 {
					   ...
					   $sql="update $tb set image='$userpic',date1='$date' where id='$id' and s_key='$skey'";
                       ...
                       {
                           header("location:../edit-main-patrika.php?data=".base64_encode($id)."_".base64_encode($tb)."_".base64_encode($skey)."");
	...
	$sql="update $tb set date1='$date' where id='$id' and s_key='$skey'";
   $conn=$rec->getrecordalldata($sql);
   if($conn)
   {
	   header("location:../main-patrika.php");
