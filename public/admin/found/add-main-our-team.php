			  ...
			  if($imgFile!=''){
				...
				{   
				  ...
				  if($imgSize < 1000000)
				  {
					 ...
					 {
					    $sql="insert into tb_gallery(name,heading,image,s_key,date,status)values('$name','$heading','$userpic','ourteam','$date','1')";
					  
                       $conn=$rec->getrecordalldata($sql);
                       if($conn)
                       {
                           header("location:../main-our-team.php");
                       }  
                       else
                       {
                           header("location:../add-main-our-team.php");
