			  ...
			  if($imgFile!=''){
				...
				{   
				  ...
				  if($imgSize < 1000000)
				  {
					 ...
					 {
					    $sql="insert into tb_gallery(name,heading,image,s_key,date,status)values('$name','$heading','$userpic','jangaranateam','$date','1')";
                       ...
                       {
                           header("location:../add-jangarana-team.php");
