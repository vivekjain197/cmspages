...
if(isset($_POST['submit']))
{
			  ...
			  $upload_dir = '../upload/message/';
			  $imgExt = strtolower(pathinfo($imgFile,PATHINFO_EXTENSION)); // get image extension
			  $valid_extensions = array('jpeg', 'jpg', 'png', 'gif');  // valid extensions
			  // rename uploading image
			  $userpic = rand(1000,1000000).".".$imgExt;
			  $delete = "../upload/message/".$preimg;
              ...
              if($imgSize < 1000000)
              {
                 ...
                 if(move_uploaded_file($tmp_dir,$upload_dir.$userpic))
                 {
                       ...
                       {
                           header("location:../edit-main-message.php?data=".base64_encode($id)."_".base64_encode($tb)."_".base64_encode($skey)."");
