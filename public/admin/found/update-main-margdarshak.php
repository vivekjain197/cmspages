			  ...
			  if($imgFile!=''){
				...
				{   
				  ...
				  if($imgSize < 1000000)
				  {
					 ...
					 {
					   $sql="update $tb set fid='$heading',name='$name',heading='$designation',image='$userpic' where id='$id'";
                    ...
                    $sql="update $tb set fid='$heading',name='$name',heading='$designation' where id='$id'";
